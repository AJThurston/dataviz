...
```{r}
ggplot() +
  geom_sf(data = y_only,         fill = "#CCCCCC", alpha = 1, color = NA) +
  ...
  geom_sf(data = x2_x3_only,     fill = "#FFFFFF", alpha = 1, color = NA) + # M+Y = red
  ...
  geom_sf(data = x1_x2_x3_only,  fill = "#000000", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#000000", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = y_x1_only,      fill = "#00FFFF", alpha = 1, color = NA) +
    geom_sf(data = y_x2_only,      fill = "#CCCCCC", alpha = 1, color = NA) +

    geom_sf(data = x1_x2_only,     fill = "#00FFFF", alpha = .5, color = NA) + 

  geom_sf(data = y_x1_x2_only,   fill = "#00FFFF", alpha = 1, color = NA) +
  geom_sf(data = y_x1_x3_only,   fill = "#00FFFF", alpha = 1, color = NA) +
    geom_sf(data = y_x2_x3_only,   fill = "#CCCCCC", alpha = 1, color = NA) +


  geom_sf(data = x1_x2_x3_only,  fill = "#00FFFF", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#00FFFF", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = y_x1_only,      fill = "#CCCCCC", alpha = 1, color = NA) +
  geom_sf(data = y_x2_only,      fill = "#FF00FF", alpha = 1, color = NA) +

  geom_sf(data = x1_x2_only,     fill = "#FF00FF", alpha = .5, color = NA) + # C+M = blue

  geom_sf(data = y_x1_x2_only,   fill = "#FF00FF", alpha = 1, color = NA) +
  geom_sf(data = y_x2_x3_only,   fill = "#FF00FF", alpha = 1, color = NA) +
  
  geom_sf(data = x1_x2_x3_only,  fill = "#FF00FF", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#FF00FF", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = y_x1_x2_only,   fill = "#CCCCCC", alpha = 1, color = NA) +
  geom_sf(data = y_x2_x3_only,   fill = "#FFFF00", alpha = 1, color = NA) +
  
  geom_sf(data = x1_x2_x3_only,  fill = "#FFFF00", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#FFFF00", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = y_x1_only,      fill = "#00FFFF", alpha = 1, color = NA) +
  geom_sf(data = y_x2_only,      fill = "#FF00FF", alpha = 1, color = NA) +
  geom_sf(data = y_x3_only,      fill = "#CCCCCC", alpha = 1, color = NA) +
  ...
  geom_sf(data = x1_x2_x3_only,  fill = "#0000FF", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#0000FF", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = x1_x2_only,     fill = "#00FFFF", alpha = .5, color = NA) + # C+M = blue

  geom_sf(data = y_x1_x2_only,   fill = "#00FFFF", alpha = 1, color = NA) +
  geom_sf(data = y_x2_x3_only,   fill = "#FFFF00", alpha = 1, color = NA) +
  
  geom_sf(data = x1_x2_x3_only,  fill = "#00FF00", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#00FF00", alpha = 1, color = NA) +
...
ggplot() +
  ...
  geom_sf(data = x1_x2_x3_only,  fill = "#FF0000", alpha = .5, color = NA) +
  geom_sf(data = y_x1_x2_x3,     fill = "#FF0000", alpha = 1, color = NA) +
